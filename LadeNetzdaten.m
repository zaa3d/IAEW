...
for k=1:24
   temp = temp + KnotenParameter(k,5) - KnotenParameter(k,7);
   temp1= temp1 + KnotenParameter(k,6) -  KnotenParameter(k,8);
end
 
if(temp>0)
    KnotenParameter(24,7) = temp;
else
    Knotenparameter(24,5) = -temp;
end
 
if(temp1>0)
    KnotenParameter(24,8) = temp1;
else
    KnotenParameter(24,6) = -temp1;
end
